   ...
   class Program
    {
        static void OAuth()
        {
            ...
            var key = "Z5jUd4NDfzAXbMLGlrQ3tUtK60o0U4x3" + ":" + "CUtVcRYq04xfxROj";
        ...
        static void B2C()
        {
            ...
            request.AddHeader("Authorization", "Bearer " + "pDzWdoXOdAIlbxXFQqsH7CwvMaR8");
            ...
            request.AddParameter("undefined", "{\r\n    " +
                ...
                "\"PartyB\": \"254708374149\",\r\n    " +
                "\"Remarks\": \"test\",\r\n    " +
                "\"QueueTimeOutURL\": \"https://arbaaz.herokuapp.com/index.php\",\r\n    " +
                "\"ResultURL\": \"https://arbaaz.herokuapp.com/index.php\",\r\n\t" +
                "\"Occasion\": \"test\"\r\n}", 
        ...
        static void C2B_Register()
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("Authorization", "Bearer " + "ht1LQJFsxTuI6WJyjlGnEWxUQzuU");
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("undefined", "{\r\n    " +
                "\"ShortCode\": \"600133\",\r\n    " +
                "\"ResponseType\": \"Completed\",\r\n    " +
                "\"ConfirmationURL\": \"https://arbaaz.herokuapp.com/index.php\",\r\n    " +
                "\"ValidationURL\": \"https://arbaaz.herokuapp.com/index.php\"\r\n}", 
                ParameterType.RequestBody);
            IRestResponse response = client.Execute(request);
            var content = response.Content;
            Console.WriteLine(content);
        ...
        static void Lipa_Na_Mpesa_Online()
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("Authorization", "Bearer " + "0voFV9Gr1AsfjBNTAcznguzpN36I");
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("undefined", "{\r\n    " +
                ...
                "\"CallBackURL\": \"https://arbaaz.herokuapp.com/index.php\",\r\n    " +
        ...
        static void Lipa_Na_Mpesa_Query()
        {
            ...
            var request = new RestRequest(Method.POST);
            request.AddHeader("Authorization", "Bearer " + "LqUPdXxahoF6mLdBkBu2Y7xkBcwG");
            request.AddHeader("Content-Type", "application/json");
            request.AddParameter("undefined", "{\r\n    " +
                "\"BusinessShortCode\": \" \" ,\r\n    " +
                "\"Password\": \" \",\r\n    " +
